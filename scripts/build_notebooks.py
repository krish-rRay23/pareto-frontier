"""Build clean, production-ready SageMaker notebooks for Amazon ML Challenge 2026."""
...
if __name__ == "__main__":
    ...
    setup_nb = build_sagemaker_setup()
    with open("notebooks/sagemaker_setup.ipynb", "w", encoding="utf-8") as f:
        json.dump(setup_nb, f, indent=1)
    print("Created notebooks/sagemaker_setup.ipynb")

    master_nb = build_master_notebook()
    with open("notebooks/amazon_ml_2026_master.ipynb", "w", encoding="utf-8") as f:
        json.dump(master_nb, f, indent=1)
    print("Created notebooks/amazon_ml_2026_master.ipynb")
